...
const MostComment = () => {
  return (
      <div className='flex flex-col items-center justify-center bg-gray-300 py-5 mt-2'>
        ...
        <div className='md:flex md:flex-row sm:flex-col'>
          {
            Data.map((data, index) => {
              return (
                  <div key={index}>
                    {data.yorum >= 380 ? <div className='card bg-[#335c67] w-80 h-[32rem] rounded-xl p-6 space-y-4 shadow-md mx-3 my-3'>
